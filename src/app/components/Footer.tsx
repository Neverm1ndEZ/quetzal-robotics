...
import { Bot, Cpu, Cog, Microscope } from "lucide-react";
...
const roboticsCategories: MenuItem[] = [
	{
		label: "Industrial Automation",
		href: "/solutions/industrial",
		icon: <Bot className="w-5 h-5 inline-block mr-2" />,
	},
	{
		label: "AI & Machine Learning",
		href: "/solutions/ai",
		icon: <Cpu className="w-5 h-5 inline-block mr-2" />,
	},
	{
		label: "Custom Engineering",
		href: "/solutions/engineering",
		icon: <Cog className="w-5 h-5 inline-block mr-2" />,
	},
	{
		label: "R&D Services",
		href: "/solutions/research",
		icon: <Microscope className="w-5 h-5 inline-block mr-2" />,
	},
];
				...
				<div className="border-t border-slate-700 pt-8">
					<div className="flex flex-col md:flex-row justify-between items-center">
						<p className="text-sm text-black mb-4 md:mb-0">
							&copy; {currentYear} Quetzal Robotics. All rights reserved.
						</p>
